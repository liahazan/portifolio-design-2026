...
export const projects: Project[] = [
  ...
  },
  {
    ...
    blocks: [
      {
        type: "image",
        src: "/projects/manaca/001.png",
        alt: "Manacá — Branding · Renovação",
        width: 2800,
        height: 3044,
      },
      {
        type: "gif",
        src: "/projects/manaca/002.gif",
        alt: "Apresentação do manual de identidade da Manacá",
        width: 2800,
        height: 1584,
      },
      {
        type: "gif",
        src: "/projects/manaca/003.gif",
        alt: "Capas de seção do relatório avaliativo da Manacá",
        width: 2498,
        height: 3318,
      },
      {
        type: "image",
        src: "/projects/manaca/004.png",
        alt: "Mockups dos relatórios institucionais da Manacá",
        width: 2800,
        height: 5653,
      },
    ],
